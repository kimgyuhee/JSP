...
<body class="bg-light">
  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
    <a class="navbar-brand mr-auto mr-lg-0" href="main.html">성공회대학교 과제제출시스템</a>
    ...
    <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a class="nav-link" href="main.html">초기화면</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="mypage.html">마이페이지</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="information.html">도움말</a>
        </li>
    ...
    <div class="row">
            ...
            <div class="media text-muted pt-3">
              ...
              <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                <div class="d-flex justify-content-between align-items-center w-100">
                  <%--학생--%>
                  <button type="button" class="btn btn-block" style="color: #6f6f6f; text-align: left; font-size: 9pt; font-weight: bold;" onclick="location.href='lecture1.html'">DB 캡스톤디자인
      ...
      <div class="col-md-3 order-md-3">
        <div class="my-3 p-3 bg-white rounded shadow-sm">
          ...
          <div>
            <h6 class="text-gray-dark">2019년 9월</h6>
            <table>
              <thead>
                <tr>
                  <td>일</td>
