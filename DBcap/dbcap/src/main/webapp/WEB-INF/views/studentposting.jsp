...
<body class="bg-light">
  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
    ...
    <a class="navbar-brand mr-auto mr-lg-0" href="main3.html">성공회대학교 과제제출시스템</a>
    ...
    <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a class="nav-link" href="main3.html">초기화면</a>
        </li>
        <li class="nav-item">
      ...
      <form class="form-inline my-2 my-lg-0">
        ...
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit" onclick="location.href='loginform.html'">로그아웃</button>
      </form>
    </div>
  </nav>
        ...
        <div class="my-3 p-3 bg-white rounded shadow-sm">
          ...
          <form class="form">
            ...
            <div style="float: right; display:inline-block; width: 900px;">
              <button class="btn btn-primary mx-2 my-sm-0" type="button" style="width: 100px; float: right" onclick="location.href='studentnotice.html'">목록보기</button>
              <button class="btn btn-primary my-2 my-sm-0" type="button" style="width: 100px; float: right" onclick="location.href='studentposting.html'">등록</button>
            </div>
            <label for=""><br></label>
          </form>
        </div>
